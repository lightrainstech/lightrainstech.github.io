...
function applyDayNightClass(){var e=new Date,t=e.getHours();t>19?$("body").addClass("night"):$("body").addClass("day")}jQuery(document).ready(function(e){jQuery(".dropdown").dropdown(),e(".logoo").popup(),e(".special.cards .image").dimmer({on:"hover"}),e(".ui.embed").embed(),e("#moobmen").on("click",function(t){e(window).width()<="767"&&(t.preventDefault(),e(".ui.sidebar").sidebar("setting","transition","push").sidebar("toggle"))});var t=window.location.pathname;e("#menu > a.item").each(function(o){-1!=t.toUpperCase().indexOf(e(this).attr("href").toUpperCase())&&e(this).addClass("active")}),e(".right.menu.open").on("click",function(t){t.preventDefault(),e(".ui.vertical.menu").toggle()}),e(".ui.dropdown").dropdown(),e(".obsa").each(function(){var t=e(this);t.attr("href",t.attr("href").replace(/x/g,"")),t.html(t.html().replace(/x/g,""))})}),jQuery(window).load(function(){if(jQuery().isotope){var e=$(".work").width(),t=$(".portfolio").isotope({itemSelector:".work",masonry:{columnWidth:e,fitWidth:!0,gutter:35}});$("#filters").on("click","a",function(){$("#filters a").removeClass("black"),$(this).addClass("black");var e=$(this).attr("data-filter");t.isotope({filter:e})})}}),jQuery().lightbox&&lightbox.option({disableScrolling:!0});